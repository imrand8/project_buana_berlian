...
<head>
    ...
    <style>
        ...
        .seat-box.selected { background: var(--p-color) !important; color: white !important; border-color: var(--p-color) !important; box-shadow: 0 5px 15px rgba(72, 61, 139, 0.3); }
        [data-theme="dark"] .seat-box.selected { background: var(--accent-gold) !important; color: black !important; border-color: var(--accent-gold) !important; box-shadow: 0 5px 15px rgba(212, 175, 55, 0.3); }
        .seat-box.occupied { background: #e0e0e0 !important; opacity: 0.6; cursor: not-allowed; border: none; color: #999 !important; }
